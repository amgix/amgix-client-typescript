...
export class AmgixApi extends runtime.BaseAPI {
     ...
     * Readiness Check
     */
    async healthReadyRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OkResponse>> {
        const queryParameters: any = {};
     ...
     * Readiness Check
     */
    async healthReady(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OkResponse> {

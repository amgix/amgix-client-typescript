...
export interface DocumentFetchRequest {
    ...
    join?: Join;
    /**
     * When true, include stored vector values on each returned document.
     * @type {boolean}
     * @memberof DocumentFetchRequest
     */
...
export function DocumentFetchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentFetchRequest {
    ...
    return {
        ...
        'join': json['join'] == null ? undefined : JoinFromJSON(json['join']),
        'with_vectors': json['with_vectors'] == null ? undefined : json['with_vectors'],
    };
}

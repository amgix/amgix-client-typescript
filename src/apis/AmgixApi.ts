...
import {
    ...
    DocumentFetchResponseFromJSON,
    DocumentFetchResponseToJSON,
...
export class AmgixApi extends runtime.BaseAPI {
    ...
    async collectionExistsRequestOpts(requestParameters: CollectionExistsRequest): Promise<runtime.RequestOpts> {
        ...
        if (this.configuration && this.configuration.apiKey) {
            headerParameters["api-key"] = await this.configuration.apiKey("api-key"); // ApiKeyHeader authentication
        }
    ...
    /**
     * Creates request options for exportDocuments without sending the request
     */
    async exportDocumentsRequestOpts(requestParameters: ExportDocumentsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
        ...
        if (requestParameters['withVectors'] != null) {
            queryParameters['with_vectors'] = requestParameters['withVectors'];
        }
        ...
        let urlPath = `/v1/collections/{collection_name}/documents/export`;
        urlPath = urlPath.replace(`{${"collection_name"}}`, encodeURIComponent(String(requestParameters['collectionName'])));
     ...
     * Export Documents
     */
    async exportDocumentsRaw(requestParameters: ExportDocumentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        const requestOptions = await this.exportDocumentsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Export Documents
     */
    async exportDocuments(requestParameters: ExportDocumentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.exportDocumentsRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for fetchDocuments without sending the request
     */
    async fetchDocumentsRequestOpts(requestParameters: FetchDocumentsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['collectionName'] == null) {
            throw new runtime.RequiredError(
                'collectionName',
                'Required parameter "collectionName" was null or undefined when calling fetchDocuments().'
            );
        }
        ...
        if (requestParameters['documentFetchRequest'] == null) {
            throw new runtime.RequiredError(
                'documentFetchRequest',
                'Required parameter "documentFetchRequest" was null or undefined when calling fetchDocuments().'
            );
        }
        ...
        let urlPath = `/v1/collections/{collection_name}/documents/fetch`;
        urlPath = urlPath.replace(`{${"collection_name"}}`, encodeURIComponent(String(requestParameters['collectionName'])));
     ...
     * Fetch Documents
     */
    async fetchDocumentsRaw(requestParameters: FetchDocumentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DocumentFetchResponse>> {
        const requestOptions = await this.fetchDocumentsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => DocumentFetchResponseFromJSON(jsonValue));
    }
     ...
     * Fetch Documents
     */
    async fetchDocuments(requestParameters: FetchDocumentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DocumentFetchResponse> {
